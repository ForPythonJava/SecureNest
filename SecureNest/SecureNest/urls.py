...
urlpatterns = [
    ...
    path("forwardComplaint/", views.forwardComplaint),
    path("replyComplaint/", views.replyComplaint),
    path("viewComplaintsPolice/", views.viewComplaintsPolice),
    path("replyComplaintPolice/", views.replyComplaintPolice),
    path("addPrograms/", views.addPrograms),
    path("viewPrograms/", views.viewPrograms),
    path("viewProgramsChild/", views.viewProgramsChild),
    path("viewProgramSchool/", views.viewProgramSchool),
    path("addComplaintSchool/", views.addComplaintSchool),
    path("replySchoolComplaint/", views.replySchoolComplaint),
    path("viewSchoolComplaints/", views.viewSchoolComplaints),
    path("forwardSchoolComplaint/", views.forwardSchoolComplaint),
    path("schoolComplaints/", views.schoolComplaints),
    path("viewSchoolComplaintsPolice/", views.viewSchoolComplaintsPolice),
    path("replySchoolComplaintPolice/", views.replySchoolComplaintPolice),
]
